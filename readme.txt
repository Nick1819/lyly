...
API: 
http://lyly.com: homapage -> describe various shit about the site
http://lyly.com/genres: list the genres of the movies 
http://lyly.com/:id: we will store movie by id in the database for convenience
...
use mongodb, react, express, nodejs for development tools
will post to github later. 
